...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1ed896c5955880cba376cd49be73dd29,en:1ed896c5955880cba376cd49be73dd29',
  THEME: process.env.NEXT_PUBLIC_THEME || 'wandk', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'wdkang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.wdkang.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'wdkang', // 网站关键词 英文逗号隔开

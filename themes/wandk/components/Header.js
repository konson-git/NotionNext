        ...
        <div className='flex h-full mx-auto justify-between items-center max-w-[86rem] px-6'>
          ...
          <div
            ...
            <div
              ...
              className={`absolute transition-all duration-500 ${activeIndex === 1 ? 'opacity-100 mb-0' : '-mb-20 opacity-0 invisible'}`}>
              <h1 className='font-bold text-center text-light-400 dark:text-gray-400 cursor-pointer hover:text-indigo-700 group-hover:text-indigo-700 dark:hover:text-yellow-700 dark:group-hover:text-yellow-600'>
